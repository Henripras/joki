    ...
    <div id="main">
        ...
        <section id="top" class="one dark cover">
            <div class="container">
                ...
                <header>
                    <h2 class="alt">Selamat Datang di <strong>Sistem Manajemen Gaji</strong> <br /> </h2>
                    <p>PT. TATA JAYA ANUGERAH</p>
                </header>
...
include("connection.php");
 ...
 $result = mysqli_query($conn, "SELECT * FROM employee ORDER BY employee_id ASC"); // using mysqli_query instead
    //while($res = mysql_fetch_array($result)) { // mysql_fetch_array is deprecated, we need to use mysqli_fetch_array 
        echo "<table><tr><th>ID</th><th>Nama</th><th>E-mail</th><th>Kota</th><th>Tanggal Masuk</th><th>Gaji Pokok</th></tr>";
...
include("connection.php");
     ...
     $result = mysqli_query($conn, "SELECT * FROM employee ORDER BY employee_id ASC"); // using mysqli_query instead
        ...
        echo "<table><tr><th>ID</th><th>Nama</th><th>E-mail</th><th>Tanggal Masuk</th><th>Gaji Pokok</th><th>Gaji Setelah Potongan</th><th>Potongan/Pajak</th><th>Export</th></tr>";
	while($res = mysqli_fetch_array($result)) { 		
        
        echo "<tr><td>" . $res["employee_id"]. "</td><td>" . $res["name"]. "</td><td> " . $res["email"]. "</td><td> " . $res["join_date"]. "</td><td> " ."Rp ". $res["annual_basic_pay"]. "</td><td> " . "Rp ". $res["monthly_pay"]. "</td><td> " . $res["tax"]." %". "</td><td><a href=\"export1.php?employee_id=$res[employee_id]\">Export</a></td></tr>";
         }
        echo "</table>";
